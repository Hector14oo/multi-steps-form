...
export default function Home() {
  ...
  return (
    <main className='lg:p-4 w-full h-full lg:w-[1024px] lg:min-h-[512px] lg:h-auto flex flex-col lg:grid lg:grid-cols-[25%_1fr] lg:grid-rows-[650px] lg:relative overflow-hidden  gap-4 lg:bg-White lg:rounded-xl before:w-full before:h-1/5 before:absolute before:bg-[url("/images/bg-sidebar-mobile.svg")] before:bg-cover before:z-[-1] lg:before:bg-none lg:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)]'>
      <section className='lg:w-full lg:h-full rounded-xl overflow-hidden'>
